...
<div class="form-group">
	...
	<input type="text" name="txtNamaFasilitas" class="form-control" value="<?=$detailFasilitasKamar['nama_fasilitas_kamar'];?>"/>

	<input type="hidden" name="txtIdFasilitasKamar" class="form-control" value="<?=$detailFasilitasKamar['id_fasilitas_kamar'];?>"/>

	<input type="hidden" name="txtFotoFasilitas" class="form-control" value="<?=$detailFasilitasKamar['foto_fasilitas_kamar'];?>"/>
</div>

<div class="form-group">
	<label class="font-weight-bold">Deskripsi Fasilitas</label>
	<textarea class="form-control" name="txtDeskripsiFasilitas" rows="5"><?=$detailFasilitasKamar['deskripsi_fasilitas_kamar'];?></textarea>
</div>
