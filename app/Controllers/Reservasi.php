...
class Reservasi extends BaseController
	...
	public function invoice($idReservasi){
		...
		$pdf->SetAuthor('Nazlaa Rohma Ningsih');
		...
		$html .='<br/><p><font size="20px"><b>Grand HotelLa</b></font></p>';

    	$html .='<br/><p style="margin-right:250px">';
    	$html .='To :</br>';
    	...
    	<td width="25px">1</td>
    	<td width="250px">Kamar : '.ucwords($detailReservasi['tipe_kamar']).' <br/>
		...
		$html .='<br/><p align= "center"><font size="12px">Dibuat secara otomatis oleh 
		sistem reservasi hotel pada tanggal :'.date('d/m/Y H:i:s').'</font></p>';
